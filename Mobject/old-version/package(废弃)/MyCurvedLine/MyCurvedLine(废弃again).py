...
"""
    ...
    ...
    @auther 巷北
    @time 2025.9.29 11:38
    今天又学会了python的一个设计模式,所以打算重新归整一下,再次优化代码结构.因为这个类,虽然添加了判断,可以显示
    两个类型的指引线条,并且也没有产生太大的问题,但是设计并不怎么样,一个类应该专门描述一个对象,然而通过判断语句,
    描述两种对象,有些冗杂.所以再次打算拆解一下,通过那个新的设计模式,来重新规划/设计一下.
"""
#_待办
"""
    无
