...
# 待办
"""
    修改图片,添加复合路径.重新设计A,使用自己设计的A.更改lgorithm的Tex,使用更好看的svg.
"""
# 导入图片就下面这样最合法
from pathlib import Path
ASSETS_DIR = Path(__file__).resolve().parent.parent / "assets"/"AlgorithmBanner"
...
class AlgorithmBanner(VGroup):
    ...
    # 上面存在bug是, 如果没有添加lgorithm或者title, FadeOut对象整体的时候, 仍然显现.
